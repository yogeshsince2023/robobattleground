      ...
      <div className="bg-forge text-text-primary min-h-screen overflow-hidden font-body">
        ...
        <section className="relative h-screen min-h-[600px] w-full bg-[#080808] overflow-hidden flex items-center justify-center">
          ...
          >
            ...
            >
              Where Machines Go to War. Book your arena slot or intern with us.
            </motion.p>
        ...
        <section className="bg-forge py-24 px-6 border-b border-plate">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
              {[
                { img: images.gallery.photo1, h: "h-80" },
                { img: images.gallery.photo2, h: "h-64" },
                { img: images.gallery.photo3, h: "h-96" },
                { img: images.gallery.photo4, h: "h-72" },
                { img: images.gallery.photo5, h: "h-64" },
                { img: images.gallery.photo6, h: "h-80" }
              ].map((item, i) => (
                <div 
                  key={i} 
